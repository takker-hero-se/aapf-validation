...
- **The original Azure lab build-out.** Regenerating the samples from scratch requires Azure subscription access and exGOAD lab definitions; see https://github.com/takker-hero-se/exGOAD if you wish to rebuild. The samples in this record are the captured outputs.
